 ...
 * 
 * <p>
 * Após a refatoração, os métodos desta classe são <strong>métodos puros</strong>,
...
public class Calculadora {
    ...
    /**
     * <p>Executa a operação matemática solicitada om base no operador informado. </p>
     * 
     ...
     * @param return o resultado da operação correspondente ao operador informado
     * 
